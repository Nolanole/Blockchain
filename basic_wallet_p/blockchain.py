...
def mine():
    ...
    try:
        ...
        response = {
            'message': 'proof and/or id NOT found'
        }
    ...
    if blockchain.valid_proof(block_string, proof):
        ...
        block_index = blockchain.new_transaction('0', miner_id, 1)
        ...
        # send success message to the miner
        response = {
    ...
    #If the proof is not valid
        ...
        response = {
            'message': 'Failure: proof not valid'
        }
        return jsonify(response), 200
...
def new_transaction():
    ...
    try:
        ...
        response = {
            'message': 'sender, recipient and/or amount NOT found'
        }
        return jsonify(response), 400
    
    index = blockchain.new_transaction(sender, recipient, amount)
    response = {
        'message': f'Blockhain index containing the new transaction: {index}'
    }
